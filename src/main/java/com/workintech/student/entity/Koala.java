...
KangarooController içirisinde kangaroo objelerini tutacak bir adet kangaroos isminde
 map tutmalısınız. Controller bean ilk oluştuğunda bu map tanımlanmalı.
